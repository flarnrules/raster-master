...
def image_to_ascii(image_path, new_width=500):
    ...
    ascii_image = Image.new('RGB', (new_width * 6, new_height * 15), color=(250, 250, 143))  # adjust dimensions and color
    ...
    for y, row in enumerate(pixels):
        ...
        d.text((0, y*15), "".join(ascii_row), fill=(255, 179, 0), font=font)  # adjust vertical positioning, fill color and font
